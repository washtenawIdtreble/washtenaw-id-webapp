...
describe("Environment Variables Utility", () => {
    ...
    test("has a constant for each known environment variable", () => {
        ...
        expect(ENVIRONMENT_VARIABLES.REACT_APP_SUBHEADING_FOCUS_TIMEOUT).toEqual("REACT_APP_SUBHEADING_FOCUS_TIMEOUT");
        expect(ENVIRONMENT_VARIABLES.REACT_APP_SUBHEADING_FOCUS_ATTEMPTS).toEqual("REACT_APP_SUBHEADING_FOCUS_ATTEMPTS");
