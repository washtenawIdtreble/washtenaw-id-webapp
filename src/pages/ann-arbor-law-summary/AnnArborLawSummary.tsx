...
export const AnnArborLawSummary = () => {
    return (<>
        ...
        <p>
            ...
            their government-issued ID card. That means a business must accept a Washtenaw County ID card as proof of
        ...
        <p>
            ...
            identity. It’s their responsibility to recognize the ID - they cannot refuse to accept it because they’ve
            never seen it before. It is issued by Washtenaw County in Ann Arbor, and mentioned by name in Ann Arbor’s
            law.
        </p>
        <p>
